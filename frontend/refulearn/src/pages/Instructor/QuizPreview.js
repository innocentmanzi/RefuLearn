      ...
      {previewMode === 'instructor' && (
        <div style={{ 
          ...
          <p style={{ 
            ...
            📝 Each question below shows the correct answer in a <strong style={{ color: '#28a745' }}>green box</strong> for your review.
          </p>
        </div>
      )}
            ...
            <div>
              ...
              {previewMode === 'instructor' && (
                <div style={{ 
                  ...
                  <strong>✓ Correct Answer:</strong> {q.options[q.correctAnswer] || 'No correct answer set'}
                </div>
              )}
                ...
                {q.options.map((opt, oIdx) => (
                  <label key={oIdx} style={{ 
                    ...
                    borderColor: answers[qIdx] === oIdx ? '#007BFF' : 
                                previewMode === 'instructor' && oIdx === q.correctAnswer ? '#28a745' : '#e9ecef'
                  }}>
                    <input
                      type="radio"
                      name={`quiz-${qIdx}`}
                    ...
                    {previewMode === 'instructor' && oIdx === q.correctAnswer && (
