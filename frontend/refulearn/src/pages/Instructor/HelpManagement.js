...
const HelpManagement = () => {
  ...
  useEffect(() => {
    const sampleTickets = [
      ...
      {
        id: 2,
        title: "Course material not loading properly",
        content: "The video lectures in Module 3 are not playing. The page keeps loading but never starts the video.",
      ...
      },
      {
        ...
        assignedTo: "instructor",
        response: "I've added 10 new practice exercises to Module 2. You can find them in the Resources section.",
  ...
  return (
    <Container>
      ...
      <Subtitle>
        Manage help requests from your students. Respond to tickets and track their status.
      </Subtitle>
