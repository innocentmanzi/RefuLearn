      ...
      try {
        ...
        if (enrollmentResponse.ok) {
          ...
          if (progressResponse.ok) {
            ...
            const completed = progressData.data.completedModules || [];
  ...
  return (
    <ContentWrapper>
      <Container>
        ...
        <CourseHeader>
          <CourseImage image={course.course_profile_picture || course.image} />
          <CourseInfo>
                    ...
                    <div style={{ flex: 1 }}>
                      ...
                      {isExpanded && (
                        <div style={{ marginTop: 12 }}>
                          <div>{mod.description || mod.content}</div>
                          {mod.video && (
                            ...
                            <div style={{ margin: '1rem 0' }}>
                              ...
                              <ul style={{ paddingLeft: 20, margin: '0.5rem 0' }}>
                                {mod.resources.map((res, rIdx) => (
                                  <li key={rIdx}>
                                    <a href={res.link} target="_blank" rel="noopener noreferrer" style={{ color: '#3498db', textDecoration: 'underline' }}>
                                      {res.name}
                                    </a>
                                  </li>
                                ))}
